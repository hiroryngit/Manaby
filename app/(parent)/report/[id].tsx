...
const s = StyleSheet.create({
  ...
  metricLabel: { ...font.tiny, color: colors.muted, marginBottom: 2 },
  metricValue: { ...font.h3 },
  heading: { ...font.h3, color: colors.text, marginTop: space.sm },
  ...
  model: { ...font.tiny, color: colors.faint, textAlign: 'center', marginTop: space.lg },
});
